        ...
        <div class="content">
            ...
            <table class="table1">
                ...
                @foreach($result['contacts'] as $contact)
                    ...
                    @endif
                        <td>
                            <a href='/company/contact/edit/{{ $contact->id }}' class="glyphicon glyphicon-pencil"></a>
                        </td>
                    </tr>
                @endforeach
                @endif
            ...
            @for($i = 0; $i < ceil($result['amount'] / $offset); ++$i)
                ...
                <a href="/company/contact/?nowPage={{ $i+1 }}">{{ $i+1 }}</a>
                @endif
            @endfor
            @endif
            </div>
...
@include('company.layout.footer')
    ...
    <script src="/js/company/contact/index.js"></script>
</html>
