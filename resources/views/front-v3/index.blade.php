...
<div class="home_div">
	...
	<div class="outer">
        ...
        <div id="popup01" class="popup_block item_5">
            ...
            <div class="box">                
                <div class="list_item">
                        @foreach($result['companyAreas']['分類01']['companies'] as $company)
                    <div class="item">
...
-->
        ...
        <div id="popup02" class="popup_block item_4">
            ...
            <div class="box">                
                <div class="list_item">
                        @foreach($result['companyAreas']['分類02']['companies'] as $company)
                    <div class="item">
                        <a href="front/company/{{ $company->id }}">
                            <div class="img"><img src="/uploads{{ $company->logo }}"></div>
                            <div class="info_outer">
...
-->
        ...
        <div id="popup03" class="popup_block item_3">
            ...
            <div class="box">                
                <div class="list_item">
                        @foreach($result['companyAreas']['分類03']['companies'] as $company)
                    <div class="item">
                        <a href="front/company/{{ $company->id }}">
                            <div class="img"><img src="/uploads{{ $company->logo }}"></div>
                            <div class="info_outer">
